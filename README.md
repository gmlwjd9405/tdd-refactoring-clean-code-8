...
#### Step2 로또 (자동)
- [nextstep 코드 리뷰](https://github.com/next-step/java-lotto/pull/497)
- [zuniors 코드 리뷰](https://github.com/zuniors/java-lotto/pull/2)

#### Step3 로또 (2등)
- [nextstep 코드 리뷰](https://github.com/next-step/java-lotto/pull/511)
